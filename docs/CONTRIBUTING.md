...
# `daisybio/cobinet-benchmarking-pipeline`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving daisybio/cobinet-benchmarking-pipeline.

This page describes the recommended nf-core way to contribute to both daisybio/cobinet-benchmarking-pipeline and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of daisybio/cobinet-benchmarking-pipeline.
...
- [ ] Check whether a GitHub [issue](https://github.com/daisybio/cobinet-benchmarking-pipeline/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [daisybio/cobinet-benchmarking-pipeline repository](https://github.com/daisybio/cobinet-benchmarking-pipeline) to your GitHub account.
...
You can contribute to daisybio/cobinet-benchmarking-pipeline without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/daisybio/cobinet-benchmarking-pipeline/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the daisybio/cobinet-benchmarking-pipeline code and processing logic more understandable for new contributors and to ensure quality.
